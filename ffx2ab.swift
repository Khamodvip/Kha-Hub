mport regedit as iphone
from regedit import com.dts.freefireth

def activate_feature(feature)
  if feature=="aimbot"
    messafebox.showinfo("aimbot","aimbot activated(100%)")
  elif feature=="fixlag":
  messagebox.showinfo("fixlag","fixlaf activated(0ms)")
  elif feature=="aimlock":
  messagebox.showinfo("aimlock","aimlock activated(100%)")
